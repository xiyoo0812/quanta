...
timer_mgr:once(2000, function()
    ...
    log_debug("db get code: {}, res = {}", code, res)
    code, res = redis_mgr:execute("JSON.SET", "json:aaa", "$", {abc = 3, nested = {ddd = 4}, removed = "nil"})
    log_debug("db json.set code: {}, res = {}", code, res)
    code, res = redis_mgr:execute("JSON.SET", "json:aaa", '$.nested.ddd', 5)
    log_debug("db json.set path code: {}, res = {}", code, res)
    code, res = redis_mgr:execute("JSON.DEL", "json:aaa", '$.removed')
    log_debug("db json.del path code: {}, res = {}", code, res)
    code, res = redis_mgr:execute("JSON.GET", "json:aaa")
    log_debug("db json.get code: {}, res = {}", code, res)
    code, res = redis_mgr:execute("DEL", "json:aaa")
