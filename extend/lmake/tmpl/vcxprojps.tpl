...
<Project DefaultTargets="Build" ToolsVersion="15.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <ItemGroup Label="ProjectConfigurations">
    <ProjectConfiguration Include="Debug|{{%= PS_PLATFORM %}}">
      ...
      <Platform>{{%= PS_PLATFORM %}}</Platform>
    </ProjectConfiguration>
    <ProjectConfiguration Include="Release|{{%= PS_PLATFORM %}}">
  ...
  <PropertyGroup Condition="'$(Configuration)|$(Platform)'=='Debug|{{%= PS_PLATFORM %}}'" Label="Configuration">
  ...
  <PropertyGroup Condition="'$(Configuration)|$(Platform)'=='Release|{{%= PS_PLATFORM %}}'" Label="Configuration">
    {{% if PROJECT_TYPE == "dynamic" then %}}
    <ConfigurationType>DynamicLibrary</ConfigurationType>
    {{% elseif PROJECT_TYPE == "static" then %}}
    <ConfigurationType>StaticLibrary</ConfigurationType>
  ...
  <ImportGroup Condition="'$(Configuration)|$(Platform)'=='Debug|{{%= PS_PLATFORM %}}'" Label="PropertySheets">
    <Import Project="$(UserRootDir)\Microsoft.Cpp.$(Platform).user.props" Condition="exists('$(UserRootDir)\Microsoft.Cpp.$(Platform).user.props')" Label="LocalAppDataPlatform" />
  </ImportGroup>
  <ImportGroup Condition="'$(Configuration)|$(Platform)'=='Release|{{%= PS_PLATFORM %}}'" Label="PropertySheets">
    <Import Project="$(UserRootDir)\Microsoft.Cpp.$(Platform).user.props" Condition="exists('$(UserRootDir)\Microsoft.Cpp.$(Platform).user.props')" Label="LocalAppDataPlatform" />
  </ImportGroup>
  <PropertyGroup Label="UserMacros" />
  <PropertyGroup Condition="'$(Configuration)|$(Platform)'=='Debug|{{%= PS_PLATFORM %}}'">
  ...
  <PropertyGroup Condition="'$(Configuration)|$(Platform)'=='Release|{{%= PS_PLATFORM %}}'">
    <TargetName>{{%= PROJECT_PREFIX %}}{{%= TARGET_NAME %}}</TargetName>
    <OutDir>$(SolutionDir)temp\bin\$(Platform)\</OutDir>
    <IntDir>$(SolutionDir)temp\$(ProjectName)\$(Platform)\</IntDir>
  </PropertyGroup>
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|{{%= PS_PLATFORM %}}'">
    <ClCompile>
      {{% if STDCPP == "c++17" then %}}
      ...
      <AdditionalIncludeDirectories>{{%= FMT_INCLUDES %}};{{%= PS_SDK_INC_DIR %}};%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>     
    </ClCompile>
    {{% if PROJECT_TYPE == "static" then %}}
    <Lib>
      <OutputFile>$(OutDir)$(TargetName)$(TargetExt)</OutputFile>
      <AdditionalLibraryDirectories>$(SolutionDir){{%= DST_DIR %}};$(SolutionDir){{%= DST_LIB_DIR %}}\$(Platform);{{%= FMT_LIBRARY_DIR %}};{{%= PS_SDK_LIB_DIR %}};%(AdditionalLibraryDirectories)
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Release|{{%= PS_PLATFORM %}}'">
    <ClCompile>
      {{% if STDCPP == "c++17" then %}}
      <CppLanguageStd>Cpp17</CppLanguageStd>
      {{% end %}}
