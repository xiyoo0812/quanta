...
Project("{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}") = "{{%= PROJECT.NAME %}}", "{{%= PROJECT_DIR %}}\{{%= PROJECT.FILE %}}ps.vcxproj", "{{{%= PROJECT.GUID %}}}"
...
Global
	GlobalSection(SolutionConfigurationPlatforms) = preSolution
		Debug|{{%= PS_PLATFORM %}} = Debug|{{%= PS_PLATFORM %}}
		Release|{{%= PS_PLATFORM %}} = Release|{{%= PS_PLATFORM %}}
	EndGlobalSection
	GlobalSection(ProjectConfigurationPlatforms) = postSolution
	{{% for _, PROJ in pairs(ALL_PROJS or {}) do %}}
		{{{%= PROJ.GUID %}}}.Debug|{{%= PS_PLATFORM %}}.ActiveCfg = Debug|{{%= PS_PLATFORM %}}
		{{{%= PROJ.GUID %}}}.Debug|{{%= PS_PLATFORM %}}.Build.0 = Debug|{{%= PS_PLATFORM %}}
		{{{%= PROJ.GUID %}}}.Release|{{%= PS_PLATFORM %}}.ActiveCfg = Release|{{%= PS_PLATFORM %}}
		{{{%= PROJ.GUID %}}}.Release|{{%= PS_PLATFORM %}}.Build.0 = Release|{{%= PS_PLATFORM %}}
	{{% end %}}
	EndGlobalSection
