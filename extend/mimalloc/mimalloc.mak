...
#自动生成目标
SOURCES =
SOURCES += mimalloc/src/alloc-aligned.c
SOURCES += mimalloc/src/alloc-posix.c
SOURCES += mimalloc/src/alloc.c
SOURCES += mimalloc/src/arena.c
SOURCES += mimalloc/src/bitmap.c
SOURCES += mimalloc/src/heap.c
SOURCES += mimalloc/src/init.c
SOURCES += mimalloc/src/libc.c
SOURCES += mimalloc/src/options.c
SOURCES += mimalloc/src/os.c
SOURCES += mimalloc/src/page.c
SOURCES += mimalloc/src/prim/prim.c
SOURCES += mimalloc/src/random.c
SOURCES += mimalloc/src/segment-map.c
SOURCES += mimalloc/src/segment.c
SOURCES += mimalloc/src/stats.c
...
pre_build:
	mkdir -p $(INT_DIR)
	mkdir -p $(TARGET_DIR)
	mkdir -p $(INT_DIR)/mimalloc/src
	mkdir -p $(INT_DIR)/mimalloc/src/prim
