...
#自动生成目标
SOURCES =
SOURCES += src/detour.cpp
SOURCES += src/detour/DetourAlloc.cpp
SOURCES += src/detour/DetourAssert.cpp
SOURCES += src/detour/DetourCommon.cpp
SOURCES += src/detour/DetourNavMesh.cpp
SOURCES += src/detour/DetourNavMeshBuilder.cpp
SOURCES += src/detour/DetourNavMeshQuery.cpp
SOURCES += src/detour/DetourNode.cpp
SOURCES += src/ldetor.cpp
