...
LCRYPT_API int rsa_public_encrypt (uint8_t *out, uint32_t *out_len, uint8_t *in, uint32_t in_len);
LCRYPT_API int rsa_public_decrypt (uint8_t *out, uint32_t *out_len, uint8_t *in, uint32_t in_len);
LCRYPT_API int rsa_private_encrypt(uint8_t *out, uint32_t *out_len, uint8_t *in, uint32_t in_len);
LCRYPT_API int rsa_private_decrypt(uint8_t *out, uint32_t *out_len, uint8_t *in, uint32_t in_len);

LCRYPT_API int rsa_init_public_key (uint8_t *pem, uint32_t pem_len);
LCRYPT_API int rsa_init_private_key (uint8_t *pem, uint32_t pem_len);
